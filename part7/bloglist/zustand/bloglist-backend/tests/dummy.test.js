...
describe('favorite blog', () => {
  ...
  test("when the list has only one blog, it returns that blog", () => {
    assert.deepStrictEqual(listHelper.favoriteBlog(listWithOneBlog), listWithOneBlog[0])
  })

  test("of a bigger list of blogs, it returns the blog with the most likes", () => {
...
describe('most blogs', () => {
  test("of a bigger list of blogs, it returns the author with the most blogs", () => {
...
describe('most likes', () => {
  test("of a bigger list of blogs, it returns the author with the most likes", () => {
